...
df_1<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市中山區')
df_2<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市中正區') 
df_3<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市大同區') 
df_4<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市萬華區') 
df_5<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市松山區') 
df_6<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市大安區') 
df_7<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市信義區') 
df_8<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市文山區') 
df_9<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市南港區') 
df_10<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市內湖區') 
df_11<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市士林區')
df_12<-df %>% select(.,thiefarea,thieftime) %>% filter(.,thiefarea=='台北市北投區')
